...
DocumentReference? get currentUserReference =>
    loggedIn ? GlowUpUserRecord.collection.doc(currentUser!.uid) : null;

GlowUpUserRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : GlowUpUserRecord.getDocument(GlowUpUserRecord.collection.doc(uid))
              .handleError((_) {}),
    )
