          ...
          child: Padding(
            ...
            child: AuthUserStreamWidget(
              builder: (context) => Builder(
                builder: (context) {
                  final glowUpBlockList =
                      (currentUserDocument?.glowUpBlockList.toList() ?? [])
                          .toList();
                  return ListView.separated(
                    padding: EdgeInsets.zero,
                    scrollDirection: Axis.vertical,
                    itemCount: glowUpBlockList.length,
                    separatorBuilder: (_, __) => const SizedBox(height: 16.0),
                    itemBuilder: (context, glowUpBlockListIndex) {
                      final glowUpBlockListItem =
                          glowUpBlockList[glowUpBlockListIndex];
                      return StreamBuilder<GlowUpUserRecord>(
                        stream:
                            GlowUpUserRecord.getDocument(glowUpBlockListItem),
